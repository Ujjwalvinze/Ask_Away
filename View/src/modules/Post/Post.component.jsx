  ...
  return loading || post === null ? (
    ...
    <Fragment>
      <div id="mainbar" className="post">
        <div className="question-header fc-white-800 pl24">
        ...
        <div className="question-date fc-black-800 pl24">
          <div className="grid-cell">
            ...
            <time dateTime={moment(post.activity.lastModified).fromNow(true)}>
              {moment(post.activity.lastModified).fromNow(true)} ago
            </time>
          </div>
        </div>
